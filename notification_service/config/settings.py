...
SECRET_KEY = os.environ.get("SECRET_KEY", "notification-service-dev-key")
...
_db_url = os.environ.get("DATABASE_URL", "postgresql://postgres:password@localhost:5432/notification_db")
